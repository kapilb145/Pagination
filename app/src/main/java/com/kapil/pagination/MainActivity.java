...
import com.kapil.pagination.api.MovieApi;
import com.kapil.pagination.api.MovieService;
...
import com.kapil.pagination.utils.PaginationScrollListener;
...
//                Log.i(TAG, "onResponse: " + (response.raw().cacheResponse() != null ? "Cache" : "Network"));
                ...
                List<TopRatedMovies.Item> results = fetchResults(response);
     ...
     * @return
     */
    private List<TopRatedMovies.Item> fetchResults(Response<TopRatedMovies> response) {
